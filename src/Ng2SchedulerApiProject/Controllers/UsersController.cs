...
using AutoMapper;
using Ng2SchedulerApiProject.ViewModels;
using Ng2SchedulerApiProject.Extensions;

// For more information on enabling Web API for empty projects, visit http://go.microsoft.com/fwlink/?LinkID=397860

namespace Ng2SchedulerApiProject.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(IUserRepository userRepository, IScheduleRepository scheduleRepository, IAttendeeRepository attendeeRepository)
        {
